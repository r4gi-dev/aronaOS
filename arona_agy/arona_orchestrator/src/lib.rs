...
pub use catalog_bridge::{resolve_or_propose as resolve_or_propose_template, TemplateResolution};
pub use confirmation::{expand_with_trust_check, ConfirmationDecision, ConfirmationGate, ExpansionOutcome};
pub use conflict_bridge::{resolve_conflict, ConflictResolutionError, FinalResolution};
...
pub use turn::{handle_permission_request, TurnError, TurnOutcome, TurnResult};